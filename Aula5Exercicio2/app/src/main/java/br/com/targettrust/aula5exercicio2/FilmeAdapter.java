...
public class FilmeAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        holder.nomeIndex   =   cursor.getColumnIndexOrThrow(br.com.targettrust.aula5exercicio2.FilmeProvider.TITULO);
        holder.fotoIndex   =   cursor.getColumnIndexOrThrow(br.com.targettrust.aula5exercicio2.FilmeProvider.CAPA);
        view.setTag(holder);
        return view;
    }
}